...
Data generated by pipelord is aggregated using the `markdown/AusTrakka_TEA_Data_Aggregation.Rmd` script. This script generates the data used in the manuscript.
