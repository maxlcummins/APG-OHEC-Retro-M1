...
Data generated by [pipelord](https://github.com/maxlcummins/pipelord) is aggregated using the `markdown/AusTrakka_TEA_Data_Aggregation.Rmd` script. This script generates the data used in the manuscript.
